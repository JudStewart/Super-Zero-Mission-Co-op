...
let cls: SuperMetroidComponent | undefined
...
@Component({
  selector: 'app-super-metroid',
  templateUrl: './super-metroid.component.html',
  styleUrls: ['./super-metroid.component.scss'],
})
export class SuperMetroidComponent implements OnInit {
